...
export default function LittleKidsPage() {
  const [showBrushGame, setShowBrushGame] = useState(true);
  ...
  return (
    <div className="space-y-8 animate-popIn">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <button
          type="button"
          onClick={() => setShowBrushGame(false)}
          className="min-h-24 rounded-[2rem] bg-white p-5 text-left shadow-playful"
        >
          <p className="text-5xl">🍎</p>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div>{showBrushGame ? (
          ...
          <LittleKidsFoodGame onAddScore={addLittleKidsScore} />
        )}</div>
